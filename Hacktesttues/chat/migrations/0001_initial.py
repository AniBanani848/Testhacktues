    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friendship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='chat.friendship')),
            ],
            options={
                'ordering': ['created_at'],
            },
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('from_user', 'to_user'), name='chat_friendship_unique_pair'),
        ),
    ]
